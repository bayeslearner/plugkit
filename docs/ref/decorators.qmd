...
```python
@component(name: str, *, namespace: str = "", version: str = "0.0.0",
           depends: list[str] | None = None, **transports)
```
...
calls only (replaces the old `internal=True`). By default all transports
can discover the runnable.
