...
- **`current_effect().is_stale()`** inside an async body — returns
  `True` once a newer run has been scheduled. Use it to short-circuit
  expensive work that's about to be redone:
