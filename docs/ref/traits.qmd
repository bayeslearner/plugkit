...
| exportable | L1 | `@exportable()` | Can be exported remotely |
...
| targeted | L3 | `properties.target` | Parameterized with a target |
| scoped | L3 | (aspirational) | Workspace-scoped |
| profiled | L3 | (aspirational) | Activation profile |
