...
## Summary: The Communication Model

```
        @requires + direct calls
        (I have it, I call its methods)
            |
            |   structural, reactive,
...
1. **@requires + direct calls** -- dependency injection. "I need this service, I call its methods."
2. **@subscribe + publish** -- event notification. "Something happened, FYI."

Transport adapters bridge the outside world to `@runnable` handlers.
