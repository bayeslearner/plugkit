...
- [ ] 1. `ctx.config.watch`
  - [ ] 1.1 The method, on the per-key signal, owned by the caller's fiber
    - **Requirements**: 1.1, 1.2, 1.3, 1.6
    - **Pillar**: Code
  - [ ] 1.2 Serialized invocation, and no call after dispose
    - **Depends**: 1.1
    - **Requirements**: 1.4, 1.5
    - **Pillar**: Code
  - [ ] 1.3 Tests asserting the properties, not the surface
    - **Depends**: 1.1
    - **Requirements**: 1.1-1.6
    - **Pillar**: Test

- [ ] 2. `points.on_change` → `points.watch`
  - [ ] 2.1 Rename, with the serialization rule applied
    - **Requirements**: 2.1, 2.2, 2.3
    - **Pillar**: Code
  - [ ] 2.2 Every call site and doc mention moves with it
    - **Depends**: 2.1
    - **Requirements**: 2.1
    - **Pillar**: Documentation, Test

- [ ] 3. The guide teaches watching
  - [ ] 3.1 Chapter 5 leads with `watch`; effects are for derived values
    - **Depends**: 1.1
