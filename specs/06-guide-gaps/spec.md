...
- [x] 2. API reference
  - [x] 2.1 A reference page over the public surface
    - **Requirements**: 2.1
    - **Pillar**: Documentation
    - `docs/api-reference.qmd`, generated by `scripts/build-api-reference.py`
      from `__all__` and one-line docstrings. Wired into the site nav, sidebar,
      and index. Added a docstring to `Fiber` and the tool decision classes.
