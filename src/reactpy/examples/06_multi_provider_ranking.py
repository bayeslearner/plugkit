...
from reactpy.kernel import Kernel, component, provides, requires, runnable, lifecycle, computed, effect, prop
...
async def main():
    ...
    print()
    r = await kernel.bus.invoke("app.query", {"sql": "SELECT * FROM users"})
