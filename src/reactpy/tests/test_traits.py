...
from reactpy.kernel import (
    ...
    subscribe, kind, skill, platform_app,
)
from reactpy.kernel.traits import TraitRegistry, Level
from reactpy.kernel.component import _finalize_meta, get_meta
...
@platform_app("bundled-app", rest_prefix="/bundled", mcp_name="bundled-tools")
@provides("IBundled")
class BundledApp:
    @lifecycle.activate
    def activate(self, rt):
