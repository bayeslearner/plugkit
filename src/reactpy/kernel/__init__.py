"""Bayeslearner Reactive Microkernel v2.

A Vue 3-style reactive component kernel for backend services.
...
from reactpy.kernel.component import (
    APIDef,
    ComponentMeta,
    ComputedDef,
    EffectDef,
...
from reactpy.kernel.lifecycle_manager import ComponentInstance, LifecycleManager, State
from reactpy.kernel.reactive import Computed as ReactiveComputed, Effect as ReactiveEffect, Signal, batch
from reactpy.kernel.registry import ServiceRegistry
from reactpy.kernel.runtime import Runtime
from reactpy.kernel.traits import Level, TraitRegistry
...
class Kernel:
    ...
    def _register_builtin_traits(self) -> None:
        from reactpy.kernel.traits import (
